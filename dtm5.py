...
def getid():
    ...
    outp.config(text = 'Find Installed Data on BCRM ZV and upload')
...
def combine():
    ...
    dfstate = pd.read_excel(states[0])
    dfstate = dfstate[['Installation','Contract Account','Equipment','Installation type','Account class']]
    
    # merge again using inst
    
    dfstate = dfstate.rename(columns = {'Installation':'Installation ID', 'Equipment':'Device No.','Contract Account' : 'Contract Acc.'})
...
Button(root, text = 'SEAL Data', command = getid).place(x = 40, y = 70) 
Button(root, text = 'Installed Data', command = combine).place(x = 33, y = 110) 
Button(root, text = 'Get Cons. (kWh)', command = getcons).place(x = 26, y = 150) 
Button(root, text = 'Get SQL Reading', command = getsql).place(x = 26, y = 190) 
Button(root, text = 'PE DTM Data Files', command = getdtm).place(x = 23, y = 230) 
# Button(root, text = 'Clean SEAL Data', command = combine).place(x = 95, y = 275) #report
Button(root, text = 'Generate DTM Analysis', command = genrep).place(x = 135, y = 275) #report
...
p1.place(x = 120, y  = 72)
p2.place(x = 140, y  = 112)
p3.place(x = 140, y  = 152)
p4.place(x = 140, y  = 192)
p5.place(x = 140, y  = 232)
b3.place(x = 30, y = 577)
b4.place(x = 67, y = 577)
...
textbox.insert(END, ' Upload files for SEAL Data')
